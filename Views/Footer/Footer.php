        ...
        <div class="row">
            ...
            <div class="col">
                <div class="c2">
                    ...
                    <p id="content2" class="text-left">The website for DDA-Comestic, created by Phạm Thị Lan Anh, Huỳnh Đức, and Đinh Thị Hồng Duyên allows customers to browse and purchase skincare products from DDA-Comestic.</p>
                </div>
            </div>
            <div class="col">
                <div class="c3">
            ...
            <div class="col">
                <div class="c4">
                    ...
                    <div class="text-left">
                        ...
                        <a href=""><i id="content3" class="fa-solid fa-location"></i> <label id="icontent">99-Tô Hiến Thành</label></a><br>
                    </div>
                </div>
            </div>
        </div>
